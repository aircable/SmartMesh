    ...
    .factory("$cordovaBeacon", ["$rootScope", function($rootScope) {
        ...
        function onDeviceReady() {
            ...
            delegate.peripheralManagerDidStartAdvertising = function(pluginResult) {
                //console.log('AIR: peripheralManagerDidStartAdvertising: '+ JSON.stringify(pluginResult.region));
        ...
        return {
            ...
            // Advertising function on iOS

            isAdvertisingAvailable: function() {
                cordova.plugins.locationManager.isAdvertisingAvailable();
            },

            startAdvertising: function( beaconRegion, measuredPower ) {
                cordova.plugins.locationManager.startAdvertising( beaconRegion, measuredPower );
            },
